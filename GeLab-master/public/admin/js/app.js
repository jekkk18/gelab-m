/******/ (() => {
        ...
        (function($, window, document, undefined) {
          ...
          function Plugin(element, options) {
            ...
            if (options.rootClass !== undefined && options.rootClass !== "dd") {
              options.listClass = options.listClass
                ? options.listClass
                : options.rootClass + "-list";
              options.itemClass = options.itemClass
                ? options.itemClass
                : options.rootClass + "-item";
              options.dragClass = options.dragClass
                ? options.dragClass
                : options.rootClass + "-dragel";
              options.handleClass = options.handleClass
                ? options.handleClass
                : options.rootClass + "-handle";
              options.collapsedClass = options.collapsedClass
                ? options.collapsedClass
                : options.rootClass + "-collapsed";
              options.placeClass = options.placeClass
                ? options.placeClass
                : options.rootClass + "-placeholder";
              options.noDragClass = options.noDragClass
                ? options.noDragClass
                : options.rootClass + "-nodrag";
              options.noChildrenClass = options.noChildrenClass
                ? options.noChildrenClass
                : options.rootClass + "-nochildren";
              options.emptyClass = options.emptyClass
                ? options.emptyClass
                : options.rootClass + "-empty";
            }
          ...
          Plugin.prototype = {
            ...
            add: function(item) {
              ...
              if (item.parent_id !== undefined) {
                ...
                if (tree.children(listClassSelector).length === 0) {
                  tree = tree.append(
                    this.options.listRenderer("", this.options)
                  );
                }
            ...
            removeItem: function(item) {
              ...
              var emptyListsSelector =
                "." + opts.listClass + " ." + opts.listClass + ":not(:has(*))";
              $(el)
                .find(emptyListsSelector)
                .remove();
                ...
                step = function(level) {
                  ...
                  items.each(function() {
                    ...
                    if (list.options.includeContent) {
                      var content = li
                        .find("." + list.options.contentClass)
                        .html();
              ...
              function traverse(item, depth, lft) {
                ...
                if (
                  $(item)
                    ...
                    .children(o.itemNodeName).length > 0
                ) {
                  depth++;
                  $(item)
                    .children(o.listNodeName)
                ...
                pid =
                  $(item)
                    .parent(o.listNodeName)
                    .parent(o.itemNodeName)
                    .attr("data-id") || "";
                if (isInt(pid)) {
                  id = parseInt(pid);
                }
            ...
            toArray: function() {
              ...
              function _recursiveArray(item, depth, left) {
                ...
                if (
                  item
                    .children(o.options.listNodeName)
                    .children(o.options.itemNodeName).length > 0
                ) {
                  depth++;
                  item
                    .children(o.options.listNodeName)
                    .children(o.options.itemNodeName)
                    .each(function() {
            ...
            setParent: function(li) {
              ...
              if (
                li.is(this.options.itemNodeName) &&
            ...
            dragStart: function(e) {
              ...
              var continueExecution = this.options.onDragStart.call(
                this,
                this.el,
                dragItem,
                position
              ...
              if (
                typeof continueExecution !== "undefined" &&
            ...
            createSubLevel: function(element, item) {
              var list = $("<" + this.options.listNodeName + "/>").addClass(
            ...
            restoreItemAtIndex: function(dragElement, indexArray) {
              ...
              function placeElement(currentEl, dragElement) {
                if (indexArray[lastIndex] === 0) {
                  ...
                  $(currentEl.children[indexArray[lastIndex] - 1]).after(
                    dragElement.clone(true)
                  ); //using true saves added to element events.
                }
              }
            ...
            dragStop: function(e) {
              ...
              var continueExecution = this.options.beforeDragStop.call(
                this,
                this.el,
                el,
                this.placeEl.parent()
              ...
              if (opt.scroll) {
                if (typeof window.jQuery.fn.scrollParent !== "undefined") {
                  ...
                  if (
                    ...
                    if (
                      opt.scrollTriggers.bottom +
                        scrollParent.offsetHeight -
                        e.pageY <
                      opt.scrollSensitivity
                    )
                      scrollParent.scrollTop = scrolled =
                        scrollParent.scrollTop + opt.scrollSpeed;
                    else if (
                      e.pageY - opt.scrollTriggers.top <
                      opt.scrollSensitivity
                    )
                      scrollParent.scrollTop = scrolled =
                        scrollParent.scrollTop - opt.scrollSpeed;
                    ...
                    if (
                      opt.scrollTriggers.right +
                        scrollParent.offsetWidth -
                        e.pageX <
                      opt.scrollSensitivity
                    )
                      scrollParent.scrollLeft = scrolled =
                        scrollParent.scrollLeft + opt.scrollSpeed;
                    else if (
                      e.pageX - opt.scrollTriggers.left <
                      opt.scrollSensitivity
                    )
                      scrollParent.scrollLeft = scrolled =
                        scrollParent.scrollLeft - opt.scrollSpeed;
                    ...
                    if (
                      ...
                      scrolled = $(document).scrollTop(
                        $(document).scrollTop() - opt.scrollSpeed
                      );
                    else if (
                      $(window).height() - (e.pageY - $(document).scrollTop()) <
                      opt.scrollSensitivity
                    )
                      scrolled = $(document).scrollTop(
                        $(document).scrollTop() + opt.scrollSpeed
                    ...
                    if (
                      e.pageX - $(document).scrollLeft() <
                      opt.scrollSensitivity
                    )
                      scrolled = $(document).scrollLeft(
                        $(document).scrollLeft() - opt.scrollSpeed
                      );
                    else if (
                      $(window).width() - (e.pageX - $(document).scrollLeft()) <
                      opt.scrollSensitivity
                    )
                      scrolled = $(document).scrollLeft(
                        $(document).scrollLeft() + opt.scrollSpeed
                  ...
                  console.warn(
                    "To use scrolling you need to have scrollParent() function, check documentation for more information"
                  );
                }
              }
  ...
  \***********************************/
    __webpack_require__(
      /*! nestable2 */ "./node_modules/nestable2/jquery.nestable.js"
    );
  })();
